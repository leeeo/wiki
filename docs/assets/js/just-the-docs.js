...
function initSearch() {
  ...
  request.open('GET', 'https://leeeo.github.io/wiki/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://leeeo.github.io/wiki/assets/css/just-the-docs-' + theme + '.css');
}
